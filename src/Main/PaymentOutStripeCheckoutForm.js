...
class PaymentOutStripeCheckoutForm extends React.Component {
  ...
  handleSubmit = async (event) => {
    ...
    const result = await stripe.confirmPayment({
      ...
      confirmParams: {
         return_url: `https://host.quizprompter.com/drb/payloading/${this.props.stripePaymentId}/${this.props.paymentId}/${this.props.eachSub.subscriptionId}/${this.props.eachSub.userId}` //Quiweb
