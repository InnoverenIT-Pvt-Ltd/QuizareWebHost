...
import EditQuestionOfQuiz from "../Container/Quiz/Child/QuizLibrary/EditQuestionOfQuiz";
import ReviewQuestionOfQuiz from "./ReviewQuestionOfQuiz";
...
export default connect(mapStateToProps, mapDispatchToProps)(ReviewQuiz);
