...
//         quizId:props.checkQuizGenerate.quizId,
...
const ChatGPT = (props) => {
  ...
  return (
      <>
          <Menu />
          <div className="flex justify-center flex-col items-center max-sm:w-11/12 mt-8 m-auto h-[60vh] md:mt-12 w-4/12 md:h-[80vh]">
              <div>
                  <img
                      className="big-logo"
                      src={FWLogo}
              ...
              <div className="absolute md:bottom-[10rem] flex flex-col justify-center items-center max-sm:m-0 h-80 m-auto">
                  {error && <div className="text-red-500">{error}</div>}
                  <div className="text-sm font-semibold text-white">
                      How many Questions?
                  </div>
                  <div className="mt-4 w-wk">
                      <Input
                          placeholder="Enter quiz name"
                          value={quizName}
                          onChange={(e) => setQuizName(e.target.value)}
