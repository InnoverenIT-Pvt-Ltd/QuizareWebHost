...
function UpdateQuizNameLibrary(props) {

  const history = useHistory();
  function handleCallBack(data) {
    history.push(`/swipeInLibrary/${props.match.params.quizId}`);
  }
  return (
    <>
      <MainHeader />
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdateQuizNameLibrary);