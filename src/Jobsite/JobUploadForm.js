      ...
      <>
        ...
        >
          {({
            ...
            <Form class=" max-sm:w-11/12 -mt-28 m-auto md:mt-0 w-3/4  ">
             
            
              <MainWrapper
              
                style={{ width: "91%", margin: "auto", background: "#3737a7",height:"66rem" }}
              >
            ...
            <div class=" max-sm:flex flex-col m-auto w-11/12 md:w-w75 mt-margin10 ml-auto mr-auto">
                ...
                <div>
                  ...
                  <div class="max-sm:w-20 -mt-6  md:mt-0 w-0 ">
                      <FastField
                ...
                {/* </div> */}
                  ...
                  /> */}
                    ...
                    <FlexContainer justifyContent="space-between">
                      ...
                      <div >
                        ...
                        name="skills"
                        isColumnWithoutNoCreate
                        placeholder="Roles at the moment"
                        selectType=""
                        width={"100%"}                    
                        component={SelectComponent}
                      ...
                      />
                        ...
                        <div class="w-auto max-sm:-mt-4">
                        <Field
                        name="roleType"
                        isColumnWithoutNoCreate
                        placeholder="Role at the moment"
                        selectType=""
                        width={"100%"}
                        isColumn                        
                  ...
                  <label class="text-white mt-6">Upload resume</label>         
                  <FastField
                    name="documentId"
                    isRequired
