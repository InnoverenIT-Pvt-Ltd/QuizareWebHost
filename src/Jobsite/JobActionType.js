...
export const GET_ROLES_NAME_REQUEST = "GET_ROLES_NAME_REQUEST";
export const GET_ROLES_NAME_SUCCESS = "GET_ROLES_NAME_SUCCESS";
export const GET_ROLES_NAME_FAILURE = "GET_ROLES_NAME_FAILURE";