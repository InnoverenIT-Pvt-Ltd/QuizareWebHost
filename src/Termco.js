...
const Termco = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto p-6 space-y-6 bg-white text-gray-800">
        <h1 className="text-4xl font-bold text-center underline">Terms and Conditions</h1>
        <p className="text-lg text-center mb-4"><strong>Last updated: March 07, 2025</strong></p>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mt-2">
          ...
          <li><strong>Company</strong> refers to NORDIND DEVELOPMENT AS, Louises gate 18B, 0169, Oslo.</li>
          ...
          <li><strong>Website</strong> refers to Quizprompter, accessible from <a href="https://quizprompter.com" className="text-blue-500 underline">quizprompter.com</a></li>
      ...
      {/* Acknowledgment */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Acknowledgment</h2>
        <p className="mt-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Placing Orders for Goods</h2>
        <p className="mt-4">
      ...
      {/* Your Information */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Your Information</h2>
        <p className="mt-4">
      ...
      {/* Order Cancellation */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Order Cancellation</h2>
        <p className="mt-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Your Order Cancellation Rights</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Availability, Errors and Inaccuracies</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Prices Policy</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Subscriptions</h2>
          <h3 className="text-xl font-semibold mt-4">Subscription Period</h3>
          <p className="mt-2">
            The Service or some parts of the Service are available only with a paid Subscription. You will be billed in advance on a recurring and periodic basis (such as daily, weekly, monthly, or annually), depending on the type of Subscription plan you select when purchasing the Subscription.
          </p>
          <h3 className="text-xl font-semibold mt-4">Subscription Cancellations</h3>
          <p className="mt-2">
            You may cancel Your Subscription renewal either through Your Account settings page or by contacting the Company. You will not receive a refund for the fees You already paid for Your current Subscription period and You will be able to access the Service until the end of Your current Subscription period.
          </p>
          <h3 className="text-xl font-semibold mt-4">Billing</h3>
          <p className="mt-2">
            You shall provide the Company with accurate and complete billing information including full name, address, state, zip code, telephone number, and a valid payment method information.
          </p>
          <h3 className="text-xl font-semibold mt-4">Fee Changes  </h3>
          <p className="mt-2">
...
effect constitutes Your agreement to pay the modified Subscription fee amount.
        ...
        <section>
        <h2 className="text-2xl font-semibold underline">Refunds</h2>
          <p className="mt-2">
...
a case-by-case basis and granted at the sole discretion of the Company.
          ...
          <h2 className="text-2xl font-semibold underline">Free Trial</h2>
          <p className="mt-2">        
...
Trial offer.
          ...
          <h2 className="text-2xl font-semibold underline">Promotions</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">User Accounts</h2>
          <p className="mt-2">
...
authorization, or a name that is otherwise offensive, vulgar or obscene.
          ...
          <h3 className="text-2xl font-semibold underline">Content </h3>
        </section>
        <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Your Right to Post Content</h2>
        <p className="mt-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Content Restrictions</h2>
        <p className="mt-4">
      ...
      {/* Content Backups */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Content Backups</h2>
        <p className="mt-4">
      ...
      {/* Copyright Policy */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Copyright Policy</h2>

        {/* Intellectual Property Infringement */}
        <h3 className="text-xl font-semibold mt-4">Intellectual Property Infringement</h3>
        <p className="mt-2">
          We respect the intellectual property rights of others. It is Our policy to respond to any claim that Content posted on the Service infringes a copyright or other intellectual property infringement of any person.
        </p>
        <p className="mt-2">
          If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at <a href="mailto:post@quizprompter.com" className="text-blue-500 underline">post@quizprompter.com</a> and include in Your notice a detailed description of the alleged infringement.
        </p>
        <p className="mt-2">
        ...
        {/* DMCA Notice */}
        <h3 className="text-xl font-semibold mt-4">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h3>
        <p className="mt-2">
        ...
        <p className="mt-4">
          You can contact our copyright agent via email at <a href="mailto:post@quizprompter.com" className="text-blue-500 underline">post@quizprompter.com</a>. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.
        </p>
      </section>

      {/* Intellectual Property */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Intellectual Property</h2>
        <p className="mt-4">
      ...
      {/* Your Feedback to Us */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold underline">Your Feedback to Us</h2>
        <p className="mt-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Termination</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Limitation of Liability</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
          <p className="mt-2">
...
the greatest extent enforceable under applicable law.
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Governing Law</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Disputes Resolution</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">For European Union (EU) Users</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">United States Federal Government End Use Provisions</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">United States Legal Compliance</h2>
          <p className="mt-2">
        ...
        <section>
          <h3 className="text-2xl font-semibold underline">Severability and Waiver</h3>
          <h2 className="text-2xl font-semibold underline">Severability </h2>
          <p className="mt-2">
          ...
          <h2 className="text-2xl font-semibold underline">Waiver</h2>
          <p className="mt-2">
...
subsequent breach.
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Translation Interpretation</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold underline">Changes to These Terms and Conditions</h2>
          <p className="mt-2">
...
Service.
        ...
        <section>
          ...
          <p className="mt-2">If you have any questions about these Terms and Conditions, You can contact us:</p>
          <ul className="list-disc pl-6 mt-2">
            <li>By visiting this page on our website: <a href="https://host.quizprompter.com" className="text-blue-500 hover:underline">host.quizprompter.com</a></li>
          </ul>
        </section>
      </div>
    );
